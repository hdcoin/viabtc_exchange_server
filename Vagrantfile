...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "mysql" do |mysql|
      ...
      mysql.vm.provision :ansible do |ansible|
        ...
        ansible.extra_vars = { root_dir: "/vagrant", mysql_user: MYSQL_USER, mysql_pass: MYSQL_PASS, mysql_user_match_host: MATCH_HOST, mysql_user_data_host: DATA_HOST, admin_host: VM_HOST }
      end
  end
